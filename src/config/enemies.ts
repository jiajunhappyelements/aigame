...
export const ENEMY_SPECS: Record<EnemyId, EnemySpec> = {
  E01: {
    ...
    bounty: 75, texture: "enemy-goblin", tint: 0x6b8e23, scale: 0.18
  },
  E02: {
    ...
    bounty: 90, texture: "enemy-E02", tint: 0xc0c0c0, scale: 0.16
  },
  E03: {
    ...
    bounty: 150, texture: "enemy-ogre", tint: 0x8b4513, scale: 0.2
  },
  E04: {
    ...
    bounty: 120, texture: "enemy-E04", tint: 0x4a4a6a, scale: 0.15
  },
  E05: {
    id: "E05", name: "幽灵", attackType: "melee", moveMode: "ground",
    unlockLevel: 4, hp: 320, atk: 27, atkSpd: 0.9, moveSpd: 1.6 * TILE_SIZE,
    range: 54, detectionRange: 250, traits: ["swift"], traitDesc: "移动速度+50%",
    bounty: 180, texture: "enemy-E05", tint: 0xdcdcdc, scale: 0.17
  },
  E06: {
    ...
    bounty: 225, texture: "enemy-E06", tint: 0x6a0dad, scale: 0.16
  },
  E07: {
    ...
    bounty: 270, texture: "enemy-E07", tint: 0xcc2200, scale: 0.19
  },
  E08: {
  ...
  E10: {
    ...
    bounty: 450, texture: "enemy-E10", tint: 0x2a0a2a, scale: 0.24
  }
};