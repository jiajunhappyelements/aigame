...
export const ENEMY_SPECS: Record<EnemyId, EnemySpec> = {
  E01: {
    ...
    range: 0.8 * TILE_SIZE, traits: [], traitDesc: "基础近战单位",
  ...
  E02: {
    ...
    range: 2.5 * TILE_SIZE, traits: [], traitDesc: "基础远程单位",
  ...
  E03: {
    ...
    range: 0.8 * TILE_SIZE, traits: ["heavy"], traitDesc: "受伤减免15%",
  ...
  E04: {
    ...
    range: 0.8 * TILE_SIZE, traits: ["flying"], traitDesc: "仅被飞行单位攻击",
  ...
  E05: {
    ...
    range: 0.8 * TILE_SIZE, traits: ["swift"], traitDesc: "移动速度+50%",
  ...
  E06: {
    ...
    range: 2.5 * TILE_SIZE, traits: ["flying"], traitDesc: "仅被飞行单位攻击",
  ...
  E07: {
    ...
    range: 0.8 * TILE_SIZE, traits: ["flying", "dragonAura"], traitDesc: "飞行+攻击溅射35%",
  ...
  E08: {
    ...
    range: 0.8 * TILE_SIZE, traits: ["heavy", "siege"], traitDesc: "受伤减免20%+对基地伤害×2",
  ...
  E10: {
    ...
    range: 0.8 * TILE_SIZE, traits: ["heavy", "siege", "command"], traitDesc: "受伤减免25%+对基地伤害×2+全体敌方ATK+10%",
